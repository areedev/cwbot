...
router.post('/api/admin/operations/all', app.getOperations)
router.post('/api/admin/operations/add', app.addOperation)
router.post('/api/admin/operations/do', app.doOperations)
router.delete('/api/admin/operations/:id', app.removeOperation)
